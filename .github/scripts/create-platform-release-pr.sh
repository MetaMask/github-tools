...
create_changelog_pr() {
    ...
    npx --yes github:MetaMask/auto-changelog#changelog-entry-adjustments update --rc --repo "${GITHUB_REPOSITORY_URL}" --currentVersion "${new_version}" --autoCategorize  --useChangelogEntry --useShortPrLink
